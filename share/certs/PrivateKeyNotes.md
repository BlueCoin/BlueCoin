...
unlocked to sign the Bleuet-Qt.app bundle.
...
allowing somebody to distribute a Bleuet-Qt.app or bleuet-qt-setup.exe with a valid
...
that the bleuet-qt.exe file inside the installer had not been tampered with.
